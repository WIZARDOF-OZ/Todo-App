...
const inputField = document.querySelector(".input-field textarea"),
 ...
 function allTasks() {
    ...
    //if tasks length is 0 then pending num text content will be no, if no then pending num value will be the tasks length
...
if(e.key === 'Enter' && inputVal.length > 0){
    ...
    inputField.value = ""; // removing value from inputField.
    allTasks();
    }
 });


 // checking and unchecking the checkbox while we click on task
